...
export default function Navbar() {
  ...
  return (
    <header
      className="bg-white/80 dark:bg-slate-800/80 md:sticky top-0 z-50 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700/50 transition-colors duration-300"
      role="banner"
    >
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <section className="title-font font-medium text-slate-900 dark:text-white hover:text-blue-500 mb-4 md:mb-0 transition-colors">
          <a
            ...
            aria-label="Garima Shingal - Back to top"
          >
            Garima Shingal
          </a>
        </section>
        ...
        <nav
          className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l border-slate-200 dark:border-slate-700 flex flex-wrap items-center text-base justify-center text-black dark:text-white font-medium"
          aria-label="Main Navigation"
        >
          <a
            href="#projects"
            className="mr-3 hover:text-blue-500 transition-colors focus:ring-2 focus:ring-blue-500 rounded px-1"
          >
            Projects
          </a>
        ...
        <div className="mt-1 md:mt-0 flex items-center space-x-4">
          ...
          <a
            ...
            aria-label="Contact me - Open contact section"
          >
            Contact Me
