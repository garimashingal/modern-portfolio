...
export default function ExperienceTab() {
  return (
    <div className="px-4 max-w-4xl mx-auto">
      ...
      <ol 
        className="relative border-l-2 border-gray-700 ml-4 sm:ml-6 space-y-12"
        ...
        {experience.map((exp, index) => {
          return (
            <li key={index} className="relative pl-8 sm:pl-12 group">
              {/* Timeline Dot */}
              <div 
                className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-gray-900 border-2 border-green-500 group-hover:scale-125 transition-transform duration-300"
                aria-hidden="true"
              ></div>
